...
from .continuous_models import mutual_info
...
class NSI:
    ...
    def _run_simulation(self,
                        ...
                        pbar_on: bool = True,
                        notebook: bool = False):
        """Shared simulation loop for homogeneous and heterogeneous population models."""
    ...
    def homogeneous_simulation(self,
        ...
        return self._run_simulation(beta, k, filepath, seedI, density, track_comm, pbar_on, notebook)
